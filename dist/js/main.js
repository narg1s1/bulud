...
function openFamily(familyName) {
    ...
    document.getElementById(familyName).style.display = "inline-table";  
}

function openOptions(evt, operatesName) {
  ...
  document.getElementById(operatesName).style.display = "block";
